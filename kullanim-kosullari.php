...
$stmt->execute(['kullanim-kosullari']);
$page = $stmt->fetch();

$pageTitle = $page ? $page['title'] : "Kullanım Koşulları";
...
<main class="flex-1 bg-white dark:bg-background-dark">
    ...
    <div class="bg-slate-50 dark:bg-slate-900 py-16 border-b border-slate-200 dark:border-slate-800">
        <div class="max-w-4xl mx-auto px-4 text-center">
            ...
            <p class="text-slate-500 dark:text-slate-400 text-lg">Lütfen platformumuzu kullanmadan önce bu koşulları dikkatlice okuyunuz.</p>
